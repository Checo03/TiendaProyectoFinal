                        ...
                        <ul class="navbar-nav mr-auto my-2 my-lg-0 navbar-nav-scroll" style="max-height: 100px;">
                            ...
                            if (isset($_SESSION['usuario_logueado'])) {
                                if ($admin_value == 0) {
                                    ...
                                    <li class="nav-item" style="margin-right: 210px;"><a href="Log_REG/log/cerrar_sesion.php" class="btn btn-outline-primary">Cerrar Sesion</a></li>
                                ...
                                <?php } elseif ($admin_value == 1) { ?>
                                    ...
                                    <li class="nav-item" style="margin-right: 160px;"><a href="Log_REG/log/cerrar_sesion.php" class="btn btn-outline-primary">Cerrar Sesion</a></li>
                                <?php } ?>
                            <?php } else { ?>
                                <li class="nav-item" style="margin-right: 10px;"><a href="LOG_REG/log/log.php" class="btn btn-outline-primary">Login</a></li>
                                <li class="nav-item" style="margin-right: 270px;"><a href="LOG_REG/registro.html" class="btn btn-outline-primary">Registrarse</a></li>
                            <?php } ?>
                            ...
                            <form style="margin-left: 80px;" class="d-flex" action="">
                                ...
                                <button class="btn btn-outline-success" style="margin-bottom: 10px;" type="submit">Buscar</button>
                            </form>
