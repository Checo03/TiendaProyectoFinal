                    ...
                    <div id="navbarSupportedContent" class="collapse navbar-collapse">
                        <ul class="navbar-nav mr-auto my-2 my-lg-0 navbar-nav-scroll" style="max-height: 100px;">
                            ...
                            <li class="nav-item dropdown" style="margin-right: 10px;">
                                <a href="#" class="nav-link dropdown-toggle text-uppercase font-weight-bold" data-bs-toggle="dropdown">Categorias</a>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="http://www.google.com">Diademas</a>
                                    <a class="dropdown-item" href="http://www.bing.com">EarBuds</a>
                                    <a class="dropdown-item" href="http://www.yahoo.com">Por marcas</a>
                                </div>
                            </li>
