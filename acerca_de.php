...
<body id="bodyAD">
    ...
    <div class="contenedor-estiloAD">
        <section id="sectionAD">
            ...
            <p>En el corazón de nuestra tienda en línea de audífonos, existe un equipo apasionado y comprometido que trabaja incansablemente para brindarte una experiencia auditiva excepcional. Cada miembro de nuestro equipo comparte una conexión profunda con el mundo del sonido, fusionando conocimientos técnicos con una pasión innata para ofrecer lo mejor en tecnología de audio.</p>
                ...
                <div class="slider">
                    <span style="--i:2"><img src="Media/Img/ImagenesAcerca/img2.png" alt="img2"></span>
                    <span style="--i:3"><img src="Media/Img/ImagenesAcerca/img3.png" alt="img3"></span>
                    <span style="--i:4"><img src="Media/Img/ImagenesAcerca/img4.png" alt="img4"></span>
                    <span style="--i:5"><img src="Media/Img/ImagenesAcerca/img5.png" alt="img5"></span>
                    <span style="--i:6"><img src="Media/Img/ImagenesAcerca/img6.png" alt="img6"></span>
                    <span style="--i:7"><img src="Media/Img/ImagenesAcerca/img7.png" alt="img7"></span>
                    <span style="--i:8"><img src="Media/Img/ImagenesAcerca/img8.png" alt="img8"></span>
                    <span style="--i:9"><img src="Media/Img/ImagenesAcerca/img9.png" alt="img9"></span>
                </div>
    </div>
    ...
    <div class="TARJETA">
        <div class="tarjetas">
          <div style="background-image: url(Media/Img/ImagenesAcerca/musica2.jpg);" class="tarjetas__item">
          ...
          <div style="background-image: url(Media/Img/ImagenesAcerca/musica3.jpg);" class="tarjetas__item">
          ...
          <div style="background-image: url(Media/Img/ImagenesAcerca/musica.jpg);" class="tarjetas__item">
